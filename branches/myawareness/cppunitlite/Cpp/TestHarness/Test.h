...
// running tests (run) as well as a data member for recording the name_ of 
// the test.
//
...
// with a global TestRegistry.  These features combine to_ make test creation
// particularly easy.
...
// a failure if the expression evaluates to_ false.  CHECK_LONGS_EQUAL
...
// If, for instance, you have a daterange class, the ability to_ compare
