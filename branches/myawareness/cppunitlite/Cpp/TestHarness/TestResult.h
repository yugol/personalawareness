...
// TestResult is a simple little class which accepts notifications from_
...
// TestResult to_ provide it.  The TestResult hierarchy can be as simple
// or complex as you require to_ support your application.
