...
public:
    ItemsDialog(wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxT("Items"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize(400, 520), long style =
